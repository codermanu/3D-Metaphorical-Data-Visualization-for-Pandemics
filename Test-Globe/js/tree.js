...
var leaveYellowMaterial = new THREE.MeshLambertMaterial( { color: 0xFFFF00 } );
var leaveLightMaterial = new THREE.MeshLambertMaterial( { color: 0xFF0000 } );
...
var squareLeave02 = new THREE.Mesh( geometry, leaveYellowMaterial );
squareLeave02.position.set( -0.4, 1.3, -0.4 );
squareLeave02.scale.set( 0.7, 0.7, 0.7 );



var leaveDark = new THREE.Mesh( geometry, leaveYellowMaterial );
